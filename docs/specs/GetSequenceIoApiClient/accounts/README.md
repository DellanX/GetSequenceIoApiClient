...
| Client support | Implemented (`GetSequenceIoApiClient/accounts.py::AccountsService.async_get_accounts`) |
| Models | `AccountSummary` |
| Query model | `AccountsListParams` |
| Tests | `tests/accounts/test_client_accounts.py`, `tests/accounts/test_accounts.py` |
...
| Client support | Implemented (`GetSequenceIoApiClient/accounts.py::AccountsService.async_get_account`) |
| Models | `Account` |
| Tests | `tests/accounts/test_client_accounts.py` |
...
| Client support | Implemented (`GetSequenceIoApiClient/activity.py::ActivityService.async_list_transfers_by_account`) |
| Models | `Transfer` |
| Query model | `TransfersByAccountListParams` |
| Tests | `tests/activity/test_activity.py` |
...
- If Accounts endpoints are added/changed in OpenAPI, update:
  - `GetSequenceIoApiClient/accounts.py`
